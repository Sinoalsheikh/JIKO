...
import { ArrowUp, ArrowDown, Users, PhoneCall, MessageSquare, BarChart } from 'lucide-react'

export function CRMHubDashboard() {
  const metrics = [
    { title: "Total Customers", value: "15,234", change: 5.2, icon: Users },
    { title: "New Leads", value: "342", change: 12.5, icon: UserCheck },
    { title: "Customer Satisfaction", value: "4.7/5", change: 0.3, icon: BarChart },
  ]

  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white">CRM Hub</h2>
