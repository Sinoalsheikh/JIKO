...
import { ArrowUp, ArrowDown, Palette, Zap, TrendingUp, Users } from 'lucide-react'

export function ProductDesignDashboard() {
  const metrics = [
    { title: "Active Design Projects", value: "18", change: 12.5, icon: Palette },
    { title: "Avg. Design Cycle Time", value: "4.2 weeks", change: -8.7, icon: Zap },
    { title: "User Testing Satisfaction", value: "4.7/5", change: 5.2, icon: Users },
  ]

  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white">Product Design and Development</h2>
      ...
      <Card className="bg-[#1A1A1A] border-[#333333]">
        <CardHeader>
          <CardTitle className="text-white">Design Process Stages</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Research & Discovery</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Ideation & Concept</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Prototyping</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">User Testing</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Refinement & Handoff</span>
