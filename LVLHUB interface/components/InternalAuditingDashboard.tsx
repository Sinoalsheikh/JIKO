...
import { ArrowUp, ArrowDown, FileCheck, AlertCircle, TrendingUp, Clock } from 'lucide-react'

export function InternalAuditingDashboard() {
  const metrics = [
    { title: "Audits Completed", value: "24", change: 9.1, icon: FileCheck },
    { title: "Critical Findings", value: "7", change: -22.2, icon: AlertCircle },
    { title: "Avg. Resolution Time", value: "15 days", change: -11.8, icon: Clock },
  ]

  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white">Internal Auditing and Compliance Checks</h2>
      ...
      <Card className="bg-[#1A1A1A] border-[#333333]">
        <CardHeader>
          <CardTitle className="text-white">Audit Compliance by Department</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Finance</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">IT</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">HR</span>
