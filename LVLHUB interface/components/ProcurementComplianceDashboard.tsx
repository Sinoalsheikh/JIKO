...
import { ArrowUp, ArrowDown, ShoppingCart, FileCheck, AlertTriangle, TrendingUp } from 'lucide-react'

export function ProcurementComplianceDashboard() {
  const metrics = [
    { title: "Compliance Rate", value: "97%", change: 2.5, icon: FileCheck },
    { title: "Violations Reported", value: "3", change: -40, icon: AlertTriangle },
    { title: "Supplier Compliance Score", value: "4.2/5", change: 0.3, icon: TrendingUp },
  ]

  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white">Procurement Compliance and Standards</h2>
      ...
      <Card className="bg-[#1A1A1A] border-[#333333]">
        <CardHeader>
          <CardTitle className="text-white">Compliance Areas</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Ethical Sourcing</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Environmental Standards</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-gray-300">Regulatory Compliance</span>
